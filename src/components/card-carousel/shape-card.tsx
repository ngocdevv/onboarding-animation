...
import { ShapeCardDescriptor, ShapeType } from "./types";
...
export const ShapeCard = ({ src, shape }: Omit<ShapeCardDescriptor, "id" | "variant">) => {
                ...
                {image ? (
                    <Group clip={shapePath}>
                        <SkiaImage
                            ...
                            y={0}
                            width={CARD_WIDTH}
                            height={shape === "scallop" ? CARD_WIDTH : CARD_HEIGHT}
                        />
                    </Group>
                ) : (
